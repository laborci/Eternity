...
use RedFox\Entity\Attachment\AttachmentDescriptor;
use RedFox\Entity\Attachment\AttachmentManager;
use RedFox\Entity\Relation\BackReference;
use RedFox\Entity\Relation\CrossReference;
use RedFox\Entity\Relation\Reference;
use RedFox\Entity\Relation\UniqueBackReference;
...
//	}
	...
	public function __get($name): \RedFox\Entity\Field { return $this->getField($name); }
}
